...
/** Bounded encoded scheduler-signature schema body; the update gate is external. */
...
struct SchedulerSignature {
    ...
    /** Exact MSB-first schema body captured after the update bit, with a low-aligned tail byte. */
