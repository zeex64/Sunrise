...
struct Targets {
    ...
    std::byte* sobjectComponentMapEncoder{};
    std::byte* sobjectResourceTableBaseSlot{};
    std::byte* sobjectCurrentObjectLookup{};
    std::byte* sobjectInboundUpdateApply{};
    std::byte* sobjectLifecycleState{};
    std::byte* sobjectComponentState{};
    std::byte* sobjectCurrentEntityResolver{};
    std::byte* sobjectCurrentDefinitionResolver{};
    std::byte* sobjectObjectTransform{};
    std::byte* authoredObjectMaterialize{};
    std::byte* authoredSpawnState{};
    std::byte* authoredSpawnInitialize{};
    std::byte* authoredSpawnQueueBuilder{};
    std::byte* authoredSquadSpawnTransform{};
    std::byte* authoredSquadSpawnObject{};
    std::byte* currentBubbleAuthority{};
    std::byte* domainAuthority{};
    std::byte* authorityStateTest{};
    std::byte* bubbleAuthorityApply{};
    std::byte* authoredSpawnReset{};
    std::byte* authoredCallbackResolver{};
    std::byte* authoredCallbackLink{};
    std::byte* authoredCallbackTableLink{};
    std::byte* sobjectNativeObjectTable{};
