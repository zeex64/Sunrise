...
bool derive(std::span<const patterns::ImageRange> image,
    ...
    resolved.accountSoidPublisher =
        matches[index(patterns::game::Id::accountSoidPublisher)].address;
    resolved.accountSoidSource = matches[index(patterns::game::Id::accountSoidSource)].address;
    resolved.accountConnectionSource =
        matches[index(patterns::game::Id::accountConnectionSource)].address;
    ...
    resolved.sobjectApplyJob = matches[index(patterns::game::Id::sobjectApplyJob)].address;
    resolved.sobjectKind0Constructor =
        matches[index(patterns::game::Id::sobjectKind0Constructor)].address;
    ...
    resolved.citizenJoinStatus = matches[index(patterns::game::Id::citizenJoinStatus)].address;
    resolved.zLegState = matches[index(patterns::game::Id::zLegState)].address;
