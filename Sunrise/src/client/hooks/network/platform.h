...
enum class HookSlot : std::size_t {
    ...
    sobjectCurrentObjectLookup,
    sobjectInboundUpdateApply,
    sobjectLifecycleState,
    sobjectComponentState,
    sobjectCurrentEntityResolver,
    sobjectCurrentDefinitionResolver,
    sobjectObjectTransform,
    authoredObjectMaterialize,
    authoredSpawnState,
    authoredSpawnInitialize,
    authoredSpawnQueueBuilder,
    authoredSquadSpawnTransform,
    authoredSquadSpawnObject,
    currentBubbleAuthority,
    domainAuthority,
    authorityStateTest,
    bubbleAuthorityApply,
    authoredSpawnReset,
    authoredCallbackResolver,
    authoredCallbackLink,
    authoredCallbackTableLink,
    count,
};
