...
constexpr std::array<const char*, kHandleCount> kSlotNames{
    ...
    "entity_slot_decoder",
    "scheduler_event_decoder",
    "scheduler_mask_decoder",
    "scheduler_entity_prelude_decoder",
    "scheduler_fixed_decoder",
    ...
    "sobject_dirty_row",
    "sobject_type2_job",
    "active_manager_refresh",
    "citizen_session_ready",
    "citizen_join_status",
    "z_leg_state",
    ...
    "sobject_current_object_lookup",
    "sobject_inbound_update_apply",
    "sobject_lifecycle_state",
    "sobject_component_state",
    "sobject_current_entity_resolver",
    "sobject_current_definition_resolver",
    "sobject_object_transform",
    "authored_object_materialize",
    "authored_spawn_state",
    "authored_spawn_initialize",
    "authored_spawn_queue_builder",
    "authored_squad_spawn_transform",
    "authored_squad_spawn_object",
    "current_bubble_authority",
    "domain_authority",
    "authority_state_test",
    "bubble_authority_apply",
    "authored_spawn_reset",
    "authored_callback_resolver",
    "authored_callback_link",
    "authored_callback_table_link",
};
