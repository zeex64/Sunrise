...
GameSpecs game_specs() noexcept {
    ...
    return {
        ...
        hooking::detour::Spec{resolved.viewMembershipSync, replacements[8]},
        hooking::detour::Spec{resolved.activityMembershipDecoder, replacements[9]},
        hooking::detour::Spec{resolved.activityMembershipQueue, replacements[10]},
        hooking::detour::Spec{resolved.viewCreator, replacements[11]},
        hooking::detour::Spec{resolved.activityHostDecoder, replacements[12]},
        hooking::detour::Spec{resolved.activityHostConnectionState, replacements[13]},
        hooking::detour::Spec{resolved.signOnReadinessFailure, replacements[14]},
        hooking::detour::Spec{resolved.signOnReadinessReady, replacements[15]},
    };
}
