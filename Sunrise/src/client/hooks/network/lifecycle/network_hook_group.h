...
inline constexpr std::array kGameSlots{
    ...
    HookSlot::sobjectCurrentObjectLookup,
    HookSlot::sobjectInboundUpdateApply,
    HookSlot::sobjectLifecycleState,
    HookSlot::sobjectComponentState,
    HookSlot::sobjectCurrentEntityResolver,
    HookSlot::sobjectCurrentDefinitionResolver,
    HookSlot::sobjectObjectTransform,
    HookSlot::authoredObjectMaterialize,
    HookSlot::authoredSpawnState,
    HookSlot::authoredSpawnInitialize,
    HookSlot::authoredSpawnQueueBuilder,
    HookSlot::authoredSquadSpawnTransform,
    HookSlot::authoredSquadSpawnObject,
    HookSlot::currentBubbleAuthority,
    HookSlot::domainAuthority,
    HookSlot::authorityStateTest,
    HookSlot::bubbleAuthorityApply,
    HookSlot::authoredSpawnReset,
    HookSlot::authoredCallbackResolver,
    HookSlot::authoredCallbackLink,
    HookSlot::authoredCallbackTableLink,
};
